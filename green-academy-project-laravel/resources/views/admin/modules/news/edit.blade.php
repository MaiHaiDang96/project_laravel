...
<div class="container">
    <div class="card card-primary">
        ...
        <form action="{{ route ('admin.news.update', ['id'=> $news->id]) }}" method="post" enctype="multipart/form-data" runat="server">
        @csrf
            <div class="card-body">
                <!-- Title -->
                <div class="form-group">
                    <label for="">News title</label>
                    <input type="text" name="name" class="form-control" placeholder="Enter name" value="{{ old('name', $news->name) }}">
                </div>
                <!-- Content -->
                <div class="form-group">
                    <label for="skle" class="form-label">Content</label>
                    <textarea type="text" class="form-control" id="cont" name="content" rows="3" placeholder="Enter content" >{{ old('content', $news->content)}} </textarea>
                ...
                <div class="row form-group">
                    <div class="col-6 justify-content-between">
                        ...
                        <div style="height:150px"><img src="{{ $news->image }}" alt="NULL" width="100px" height="100px"></div>
                    </div>
                    <div class="col-6 justify-content-between">
                        <div class="form-group">
                        ...
                        <div style="height:150px"><video src="{{ $news->video }}" alt="" width="100px" height="100px"></div>
                    </div>
                </div>
            </div>
            <!-- /.card-body -->
            <div class="card-footer">
                ...
                <a href="{{ route ('admin.news.index') }}"><h5>Cancel</h5></a>
            </div>
        </form>
